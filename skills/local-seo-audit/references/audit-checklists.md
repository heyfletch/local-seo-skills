...
Verbatim reference material for audit execution. Score each category 0-100 and flag issues.
...
### 2. GBP Predefined Services (NEW 2026)
...
- CRITICAL: Pages must have genuinely unique local content
...
## F. AI Search Visibility Audit (NEW 2026)
